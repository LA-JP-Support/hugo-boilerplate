...
type = "glossary"
draft = false
url = "/internal/glossary/Blue-Green-Deployment/"
...
Azure Container Apps supports blue-green deployment via [revisions](https://learn.microsoft.com/en-us/azure/container-apps/revisions), [traffic splitting](https://learn.microsoft.com/en-us/azure/container-apps/traffic-splitting), and [labels](https://learn.microsoft.com/en-us/azure/container-apps/revisions#labels).  
...
- **AWS:**  
  AWS enables blue-green deployments using [CodeDeploy with Elastic Load Balancing](https://docs.aws.amazon.com/whitepapers/latest/blue-green-deployments/introduction.html), orchestrating traffic shift and health checks.

- **Azure:**  
  Azure Container Apps utilizes [revisions and traffic weights](https://learn.microsoft.com/en-us/azure/container-apps/blue-green-deployment) to manage blue-green strategies.
