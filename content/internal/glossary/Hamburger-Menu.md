...
description = "Un menú hamburguesa es un elemento de interfaz gráfica con tres líneas apiladas que revela un menú de navegación oculto al hacer clic. Esencial para el diseño web móvil y responsivo."
keywords = ["menú hamburguesa", "diseño UI/UX", "navegación móvil", "revelado progresivo", "accesibilidad web"]
category = "General"
type = "glossary"
date = 2025-12-05
lastmod = 2025-12-05
draft = false
url = "/internal/glossary/Hamburger-Menu/"
...
## Cómo y Dónde se Usan los Menús Hamburguesa
...
## Pros y Contras de los Menús Hamburguesa
...
- Usa el clásico icono de tres líneas—sencillo, de igual longitud.
- Colócalo de forma consistente (arriba a la izquierda para la mayoría de idiomas; arriba a la derecha para layouts RTL o accesibles al pulgar).
- Evita bordes innecesarios o adornos.
- Añade una etiqueta “Menú” para audiencias poco familiarizadas o contextos únicos.
- Asegura la clicabilidad: usa estados hover y cambios de cursor.
- Proporciona tamaño y relleno adecuados para fácil toque.
- Contraste alto entre icono y fondo.
- Animaciones sutiles (por ejemplo, morph a “X” al abrir) refuerzan la interactividad.

*Guía: [NNG: Buenas Prácticas del Icono de Hamburguesa](https://www.nngroup.com/articles/hamburger-menu-icon-recognizability/), [Justinmind: Guía de Diseño de Menú Hamburguesa](https://www.justinmind.com/ui-design/hamburger-menu)*

### Guías UX

- No ocultes funciones principales; úsalo para acciones secundarias o poco frecuentes.
- Considera navegación híbrida—combina pestañas/barras visibles con hamburguesa para elementos menos usados.
- Monitoriza analíticas para enlaces o funciones poco visitadas.
- Haz pruebas de usuario sobre reconocimiento de iconos y accesibilidad.
- Evita confusión de iconos—no coloques iconos similares cerca.
- Asegura una apertura rápida y fluida del menú.

### Consideraciones de Accesibilidad

- Usa HTML semántico: elementos `<button>` para el disparador del menú.
- Añade `aria-label="Menú"` o similar para lectores de pantalla.
- Haz el menú accesible por teclado (Tab para abrir, flechas para navegar).
- Proporciona estados de foco visibles para todos los elementos interactivos.
- Garantiza suficiente contraste de color y grandes áreas táctiles.

*Accesibilidad: [UXDesign.cc: Crea un Menú Hamburguesa Accesible](https://uxdesign.cc/create-an-accessible-hamburger-menu-869b0301cfd7), [UserWay: Buenas Prácticas de Navegación Accesible](https://userway.org/blog/website-navigation/)*
...
| Patrón         | Descubribilidad | Eficiencia Espacial | Adecuado Para           |
| -------------- | --------------- | ------------------- | ----------------------- |
| Menú Hamburguesa | Baja           | Alta                | Móvil, Navegación Sec.  |
| Barra de Pestañas | Alta          | Moderada            | Móvil, Navegación Principal |
| Barra Inferior   | Alta           | Moderada            | Móvil, Navegación Frecuente |
| Barra Lateral    | Alta           | Baja                | Escritorio, Pantallas Grandes|

Elige el modelo que se ajuste a las necesidades de tus usuarios y la importancia de las opciones que ofreces.

*Comparaciones: [Justinmind: Patrones de Navegación](https://www.justinmind.com/blog/navigation-design-almost-everything-you-need-to-know/)*
...
- La interfaz tiene espacio para navegación visible.

*Detalles: [Interaction Design Foundation](https://www.interaction-design.org/literature/article/hamburger-menu-ux)*

## Notas de Implementación y Consejos Prácticos
...
- Usa `<button>` por semántica y navegación por teclado.
- Añade `aria-label` para lectores de pantalla.
- Asegura área táctil suficiente y estados de foco visibles.

*Demo: [Ejemplo en CodePen](https://codepen.io/Danilo06/pen/PoNNvGm), [UXDesign: Menú Hamburguesa Accesible](https://uxdesign.cc/create-an-accessible-hamburger-menu-869b0301cfd7)*
...
- Usa menús hamburguesa solo cuando el espacio sea limitado o las opciones sean secundarias.
- Prefiere la navegación visible cuando sea posible.
- Sigue patrones e iconos familiares y su ubicación estándar.
- Etiqueta el menú si hay dudas sobre su reconocimiento.
- Nunca ocultes funciones críticas; mantén acciones clave visibles.
- Prueba la usabilidad y accesibilidad con usuarios reales.
- Asegura soporte para teclado y lectores de pantalla.

*Consejo experto: [NNG: Reconocimiento del Icono de Menú Hamburguesa](https://www.nngroup.com/articles/hamburger-menu-icon-recognizability/)*

## Lecturas y Recursos Adicionales

- [Interaction Design Foundation: UX del Menú Hamburguesa](https://www.interaction-design.org/literature/article/hamburger-menu-ux)
- [NNG: El Icono de Menú Hamburguesa Hoy: ¿Es Reconocible?](https://www.nngroup.com/articles/hamburger-menu-icon-recognizability/)
- [Justinmind: Guía de Diseño de Menú Hamburguesa](https://www.justinmind.com/ui-design/hamburger-menu)
- [HubSpot: ¿Qué es un Botón Hamburguesa?](https://blog.hubspot.com/website/hamburger-button)
- [TechTarget: Icono Hamburguesa (navegación de cajón deslizante)](https://www.techtarget.com/whatis/definition/hamburger-icon-slide-drawer-navigation)
- [NNG YouTube: Actualización del Icono de Menú Hamburguesa](https://www.youtube.com/watch?v=1au4Gff9cSo)
- [NNG: La Navegación Oculta Daña los Métricas UX](https://www.nngroup.com/articles/hamburger-menus/)
- [Justinmind: Patrones de Diseño de Navegación](https://www.justinmind.com/blog/navigation-design-almost-everything-you-need-to-know/)
- [Netwizard: Pros y Contras del Menú Hamburguesa](https://netwizarddesign.com.au/the-three-line-menu-option-called-hamburger-menu-what-are-the-pros-and-cons/)
...
- [Interaction Design Foundation: UX del Menú Hamburguesa](https://www.interaction-design.org/literature/article/hamburger-menu-ux)
- [UXDesign.cc: Guía de Menú Hamburguesa Accesible](https://uxdesign.cc/create-an-accessible-hamburger-menu-869b0301cfd7)
- [UserWay: Buenas Prácticas de Navegación Web](https://userway.org/blog/website-navigation/)
- [NNG: Los Menús Hamburguesa Dañan las Métricas UX](https://www.nngroup.com/articles/hamburger-menus/)
- [Justinmind: Guía de Diseño de Menú Hamburguesa](https://www.justinmind.com/ui-design/hamburger-menu)

Para profundizar en implementación, accesibilidad y mejores prácticas UX, visita los enlaces recomendados de lectura adicional. Este glosario consolida la investigación más reciente y el consenso experto sobre los menús hamburguesa, su historia, uso, buenas prácticas y accesibilidad.