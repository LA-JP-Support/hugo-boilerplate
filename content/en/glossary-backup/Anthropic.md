...
**Core values include:**- Acting for the global good and prioritizing universally beneficial outcomes.
...
**Key milestones:**- **2021:**Anthropic is incorporated as a public-benefit corporation in San Francisco.
...
**Pricing Overview (as of 2025):**| Model         | Input (per million tokens) | Output (per million tokens) |
|---------------|---------------------------|-----------------------------|
| Opus          | $15                       | $75                        |
| Sonnet        | $3                        | $15                        |
| Haiku         | $0.25                     | $1.25                      |
...
- **Training Phases:**- **Supervised Learning (SL):**The model generates responses, critiques them using constitutional principles, and revises accordingly.
...
- **Plans:**- **Free Tier:**Limited daily usage (e.g., 30 messages per day), access to Claude Sonnet.
...
**Getting Started:**1. Visit [claude.ai](https://claude.ai)
