...
- Hierarchical (e.g., "isSubClassOf," "managed_by")
...
**Node attributes:**  
- Name, birthdate, address, status, category, etc.

**Edge attributes:**  
- Start date, duration, relevance, ranking, etc.

**Examples:**  
- Node: "Paris" (type: City, population: 2.1 million, country: France)
...
- **Classes:** Hierarchical categories (Person, Organization, City, etc.)
...
**Example:**  
A movie ontology might specify:
...
**Example:**  
- URI: `https://example.com/id/apple-inc`
...
**Types of inference:**
- **Ontology-based:** Uses schema/ontology rules to infer new relationships (e.g., transitive, symmetric, or inverse relationships).
- **Graph algorithms:** Includes path finding (e.g., shortest path), centrality detection (e.g., PageRank), and community detection.

**Examples:**  
- If "Alice" is parent of "Bob" and "Bob" is parent of "Carol," the graph can infer "Alice" is grandparent of "Carol."
...
Popular graph databases include Neo4j, Amazon Neptune, and GraphDB. Query languages include SPARQL (for RDF) and Cypher (for property graphs).

**Integration:**  
Knowledge graphs excel at connecting previously siloed data from multiple sources, providing a unified, machine-interpretable network for richer analytics and more accurate AI-driven insights.
...
**Ontology Components:**  
- **Classes:** e.g., Person, Organization, City  
...
- **Graph-based:** Path finding (e.g., shortest path), centrality (e.g., PageRank), community detection
- **Ontology-based:** Logical deduction using class hierarchies, transitive/symmetric/inverse relationships

**Real-world uses:**  
- Inferring grandparent relationships from parent links  
...
- **Google Knowledge Graph:**  
  Powers Google Search, providing contextual information about people, places, and things, and enabling features like the Knowledge Panel.  
  [Read more](https://blog.google/products/search/introducing-knowledge-graph-things-not/)

- **DBpedia:**  
  Extracts structured data from Wikipedia, forming a vast open knowledge graph for public use.  
  [DBpedia](https://wiki.dbpedia.org/)

- **Wikidata:**  
  A collaboratively edited knowledge graph supporting Wikimedia projects.  
  [Wikidata](https://www.wikidata.org/)

- **LinkedIn Economic Graph:**  
  Maps relationships between professionals, companies, skills, and opportunities.  
  [LinkedIn Economic Graph](https://economicgraph.linkedin.com/)

- **Facebook Entity Graph, Amazon Product Graph:**  
  Drive social and product recommendations by linking users, content, and products.

### Industry Use Cases

- **Search and Question Answering:**  
  Knowledge graphs deliver direct, context-aware answers to user queries.  
  [Source: AIMultiple](https://research.aimultiple.com/knowledge-graph/)

- **Recommendation Systems:**  
  Used in e-commerce and streaming (e.g., Amazon, Netflix) to personalize product or content suggestions.

- **Fraud Detection and Risk Analysis:**  
  Financial institutions use knowledge graphs to map and analyze relationships among entities, improving detection of suspicious patterns and AML/KYC compliance.

- **Healthcare and Biomedical Research:**  
  Integrate patient records, medical research, and clinical guidelines to support diagnostics and drug discovery.

- **Enterprise Knowledge Management:**  
  Organize internal data, documents, and expertise for easier discovery and reuse.

- **Supply Chain Optimization:**  
  Connects data from all supply chain stages, enabling logistics optimization and risk forecasting.

- **Customer 360 and Master Data Management:**  
  Unifies customer or product data from multiple systems for a holistic view.

**Mini-Scenario:**  
If a product recall is issued by "Vendor C" for "Product B," a retail knowledge graph can immediately identify all affected customers and orders by traversing the supplier-product-customer relationships.
...
1. **Define Scope/Purpose:**  
   Identify the domain, key entities, and target use cases.
2. **Data Collection/Preparation:**  
   Gather, cleanse, and normalize data from various sources.
3. **Entity/Relationship Extraction:**  
   Use NLP and machine learning to identify and categorize entities and relationships.
4. **Design Ontology (Schema):**  
   Specify entity types, relationships, attributes, and constraints.
5. **Graph Database Selection:**  
   Choose the right technology (Neo4j, Amazon Neptune, GraphDB, etc.).
6. **Data Loading:**  
   Ingest data into the graph model, ensuring linkage and consistency.
7. **Query & Analyze:**  
   Use languages like Cypher, SPARQL, or Gremlin for queries and analytics.
8. **Visualization & Integration:**  
   Employ visualization tools (Gephi, Linkurious) and integrate with applications.
9. **Maintenance:**  
   Continuously enrich, update, and validate the graph as new data arrives.
...
A graph database is a storage technology for managing connected data. A knowledge graph is a data model (often implemented on a graph database) enriched with semantics and ontologies for advanced reasoning.

**What is a triplestore?**  
A triplestore is a database for managing subject-predicate-object triples (e.g., "Paris" —[isCapitalOf]→ "France"), foundational for semantic web and RDF-based knowledge graphs.

**Do large language models (LLMs) use knowledge graphs?**  
LLMs are primarily trained on text, but combining them with knowledge graphs (e.g., in Retrieval-Augmented Generation/RAG) enhances AI by grounding responses in structured, verified knowledge.

**What is inference in a knowledge graph?**  
Inference is deducing new facts from existing data using logical or graph algorithms (e.g., inferring grandparent relationships or detecting influential nodes).

**Can knowledge graphs be updated as information changes?**  
Yes, knowledge graphs are dynamic and can be updated with new nodes, relationships, and attributes as new information becomes available.
