...
**In-depth resources:**- [Weaviate Platform Overview](https://weaviate.io/platform)  
...
> **Deep dive:**> [Vector Embeddings Explained](https://weaviate.io/blog/vector-embeddings-explained)  
...
> **Technical details:**> [Vector Index Configuration](https://docs.weaviate.io/weaviate/config-refs/indexing/vector-index)  
...
**Further reading:**- [Scaling and Weaviate (Weaviate Blog)](https://weaviate.io/blog/scaling-and-weaviate)
...
> **Comprehensive feature list:**> [Weaviate Platform Features](https://weaviate.io/platform#open-source-vector-database-features)
...
> **Further reading:**> [What is a Vector Database?](https://weaviate.io/blog/what-is-a-vector-database)

## Getting Started with Weaviate

### Quickstart Steps

1. **Spin up an instance:**- [Weaviate Cloud Quickstart](https://docs.weaviate.io/weaviate/quickstart)
...
**More code samples:**- [Weaviate Recipes GitHub](https://github.com/weaviate/recipes)

## Community & Support

- **Open Source:**- [Weaviate GitHub](https://github.com/weaviate/weaviate)
  - Feature requests, contributions, and code browsing.
- **Documentation & Tutorials:**- [Weaviate Docs](https://docs.weaviate.io/weaviate)
  - [Weaviate Academy](https://academy.weaviate.io/)
- **Community:**- [Slack](https://weaviate.io/slack): Q&A, events, discussions.
  - [Blog](https://weaviate.io/blog): Technical posts, updates, case studies.
- **Support:**- Community via forums and Slack.
  - Enterprise: Dedicated support with Weaviate Cloud.

> **Testimonial:**> “Weaviate's batteries-included approach, incorporating both [model serving](/en/glossary/model-serving/) and multi-tenancy, has helped us quickly prototype and build our vector search at Stack.” — Stack Overflow Team

## FAQ

**Q: Is Weaviate open source?**A: Yes, BSD-3-Clause license ([GitHub](https://github.com/weaviate/weaviate)).

**Q: Can I use Weaviate for Retrieval-Augmented Generation (RAG)?**A: Yes, Weaviate is widely used as a RAG backend ([RAG Docs](https://weaviate.io/rag)).

**Q: Does Weaviate support hybrid search?**A: Yes, it natively combines semantic (vector) and keyword (BM25) search ([Hybrid Search](https://docs.weaviate.io/weaviate/search/hybrid)).

**Q: What languages and SDKs are available?**A: Python, Go, JavaScript, TypeScript, Java, REST, and GraphQL ([SDK Reference](https://docs.weaviate.io/weaviate/client-libraries)).

**Q: How does Weaviate handle scaling and high availability?**A: Horizontal [sharding](/en/glossary/sharding/), clustering, and replication ([Scaling Guide](https://docs.weaviate.io/weaviate/concepts/cluster)).

**Q: Is Weaviate suitable for enterprise use?**A: Yes. It offers RBAC, encryption, audit
