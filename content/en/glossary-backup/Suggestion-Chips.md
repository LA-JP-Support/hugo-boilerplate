...
- **Visual Distinction:**Pills or bubbles, often rendered according to [Material Design guidelines](https://m3.material.io/components/chips/guidelines), with clear padding and separation from the main chat stream.
...
**Key Point:**Suggestion chips are for quick, contextual, one-off decisions; buttons are for ongoing actions or navigation.

### Suggestion Chips vs. Quick Replies

- **Terminology:**"Quick replies" is the term for this pattern on [Facebook Messenger](https://developers.facebook.com/docs/messenger-platform/send-messages/quick-replies/) and [Telegram](https://core.telegram.org/bots/api#replykeyboardmarkup). Google names them "suggestion chips" in Dialogflow and Assistant.
...
**See:**[Activechat: Chatbot buttons vs quick replies](https://activechat.ai/news/chatbot-buttons-vs-quick-replies/)
...
- **Smart Chips:**In [Google Docs](https://support.google.com/docs/answer/10710316?hl=en), these are document-embedded elements for links, people, or files—not related to conversational UI.
...
- **Native Support:**Suggestion chips are supported in Dialogflow CX and ES integrations for [Google Assistant](https://developers.google.com/assistant/df-asdk/rich-responses), web chat, and compatible channels.
...
- **Quick Replies:**- Up to 13 quick replies per message ([docs](https://developers.facebook.com/docs/messenger-platform/send-messages/quick-replies/)).
...
- **ReplyKeyboardMarkup:**- Provides custom keyboards for one-tap replies ([docs](https://core.telegram.org/bots/api#replykeyboardmarkup)).
...
- **Accessibility:**Ensure chips have sufficient color contrast, are screen-reader friendly, and have clear labels. Follow [Material Design accessibility guidance](https://m3.material.io/components/chips/guidelines).
...
1. **Slot Filling in Ordering Flows** *Prompt:* “Choose a drink size.”  
   *Chips:* [Small] [Medium] [Large]  
   *Outcome:* User taps a chip to fill the slot without typing.

2. **Disambiguation After Invalid Input** *Prompt:* “Sorry, please select vehicle type:”  
   *Chips:* [Car] [Truck]

3. **Quick Surveys or Feedback** *Prompt:* “Was this helpful?”  
   *Chips:* [Yes] [No]

4. **Branching Conversation Paths** *Prompt:* “What would you like to do?”  
   *Chips:* [Browse] [Order Status] [Support]

5. **Collecting Sensitive Data** *Prompt:* “Share your contact info.”  
...
**Q: What about accessibility?**A: Ensure good color contrast, readable fonts, and ARIA labels as per [Material Design accessibility guidelines](https://m3.material.io/components/chips/guidelines).
...
**Key Takeaway:**Use suggestion chips (quick replies) for rapid, context-driven user input. Limit the number for clarity, keep labels concise, and always handle free-form input.

**Related Terms:**- [Natural Language Understanding (NLU)](https://en.wikipedia.org/wiki/Natural-language_understanding)
...
**See also:**- [Insert smart chips in Google Docs](https://support.google.com/docs/answer/10710316?hl=en) *(for document collaboration, not chatbots)*

**Last updated:**2024-06

**Sources and References:**- [Dialogflow Rich Responses Documentation](https://developers.google.com/assistant/df-asdk/rich-responses)
- [Material Design 3: Chips](https://m3.material.io/components/chips/guidelines)
- [Facebook Messenger Quick Replies](https://developers.facebook.com/docs/messenger-platform/send-messages/quick-replies/)
- [Telegram Bot API: ReplyKeyboardMarkup](https://core.telegram.org/bots/api#replykeyboardmarkup)
- [Activechat: Chatbot buttons vs quick replies](https://activechat.ai/news/chatbot-buttons-vs-quick-replies/)
