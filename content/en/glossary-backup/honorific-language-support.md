---
title: "honorific language support"
date: 2025-12-17
...
Keigo is the backbone of Japanese politeness. It encodes respect, humility, and social structure into grammar and vocabulary. The three main categories are:

- 尊敬語 (Sonkeigo): Respectful language to elevate the status of others.
- 謙譲語 (Kenjōgo): Humble language to lower one’s own or in-group’s actions.
- 丁寧語 (Teineigo): Polite language, the default safe register for most formal interactions.
...
- Superior: 部長がいらっしゃいます。  
  The manager will come (respectful).

See full breakdown: [Nichijougo Keigo Guide](https://nichijougo.com/a-comprehensive-guide-to-honorific-language)
...
See more: [OTRanslator - Mastering Honorifics](https://otranslator.com/en/blog/japanese-translation)
...
Further detail: [Nichijougo - Keigo Types](https://nichijougo.com/a-comprehensive-guide-to-honorific-language)

### Name Honorifics: Suffixes & Prefixes

Japanese attaches honorifics to names and nouns to signal respect, familiarity, or formality.

#### Suffixes

| Suffix | Japanese | Usage | Example |
|--------|----------|-------|---------|
| -san   | さん     | Neutral, safe default | 田中さん (Tanaka-san) |
| -sama  | 様      | Highly respectful (customers, gods) | お客様 (o-kyaku-sama) |
| -kun   | 君      | Male juniors or equals | 太郎くん (Tarou-kun) |
| -chan  | ちゃん   | Affectionate, children, pets | ゆみちゃん (Yumi-chan) |
| -shi   | 氏      | Very formal, written reports | 田中氏 (Tanaka-shi) |

#### Prefixes

| Prefix | Japanese | Usage | Example |
|--------|----------|-------|---------|
...
## Cultural and Social Context of Honorific Use
...
[Further Reading: VerbalPlanet - Honorific Language](https://www.verbalplanet.com/learn-japanese/blog/japanese-keigo-honorific-language.asp)

### Social Hierarchy and Politeness

- Age, job rank, and experience all affect expected keigo level.
- Business, ceremonial, and customer service contexts require the highest attention to proper form.
- The goal is to maintain harmony (wa) and show appropriate respect (sonkei).

See: [Coto Academy - Introduction to Keigo](https://cotoacademy.com/japanese-keigo/)

## How Honorific Language Support Is Used
...
See: [OTRanslator - AI and Keigo](https://otranslator.com/en/blog/japanese-translation)
...
### Verb Transformations Table

| Meaning | Plain | Polite | Sonkeigo (Respectful) | Kenjougo (Humble) |
|---------|-------|--------|-----------------------|-------------------|
| to go   | 行く (iku) | 行きます (ikimasu) | いらっしゃる / いらっしゃいます (irassharu/irasshaimasu) | 参る (mairu) |
| to come | 来る (kuru) | 来ます (kimasu) | いらっしゃる / お見えになる (irassharu / o-mie ni naru) | 参る (mairu) |
| to do   | する (suru) | します (shimasu) | なさる (nasaru) | いたす (itasu) |
| to say  | 言う (iu)   | 言います (iimasu) | おっしゃる (ossharu) | 申す (mousu), 申し上げる (moushiageru) |
...
### Honorific Suffixes and Prefixes Table

| Suffix/Prefix | Used For | Example | Notes |
|---------------|----------|---------|-------|
| -san (さん)   | Most people | 佐藤さん (Satou-san) | Neutral, safe default |
| -sama (様)    | Customers, dignitaries | お客様 (o-kyaku-sama) | Highest respect |
| -kun (君)     | Male juniors | 健太くん (Kenta-kun) | Not for superiors |
| -chan (ちゃん)| Children, close friends | みきちゃん (Miki-chan) | Affectionate |
| -shi (氏)     | Formal writing | 高橋氏 (Takahashi-shi) | Neutral, distant |
| o- (お)       | Native words | お名前 (o-namae), お茶 (ocha) | Polite prefix |
| go- (ご)      | Sino-Japanese words | ご家族 (gokazoku), ご意見 (goiken) | Polite prefix |
...
- Japanese honorific language support is essential for both human and machine communication in Japanese society and business.
- Keigo is divided into respectful (sonkeigo), humble (kenjougo), and polite (teineigo) forms.
- Mastery requires understanding of social hierarchy, in-group/out-group dynamics, and context.
- AI systems must be context-aware and dynamically adapt their output.
- Common mistakes include overuse, underuse, and incorrect register switching.
- Continuous practice, observation, and feedback are necessary for both humans and AI to use honorifics effectively.

## References

1. [Mastering the Art of Japanese Keigo – Nichijougo](https://nichijougo.com/a-comprehensive-guide-to-honorific-language)
2. [Mastering Honorifics: The Complete Guide to Perfect Japanese Keigo Translation – OTranslator](https://otranslator.com/en/blog/japanese-translation)
3. [Ultimate Guide to Japanese Language Levels – Kylian.ai](https://www.kylian.ai/blog/en/japanese-language-levels)
4. [Busuu: Japanese Honorifics: San, Chan, Kun and Beyond](https://www.busuu.com/en/japanese/honorifics)
5. [VerbalPlanet: Introduction to Japanese Keigo](https://www.verbalplanet.com/learn-japanese/blog/japanese-keigo-honorific-language.asp)
6. [Coto Academy: Introduction to Japanese Keigo](https://cotoacademy.com/japanese-keigo/)

For further learning, see instructional videos such as [Japanese Keigo Explained – YouTube](https://www.youtube.com/watch?v=2i5A6qU3qN8) and [Business Japanese: Mastering Keigo – YouTube](https://www.youtube.com/watch?v=3ScLzKZ0n7M).

This glossary and guide distills the most authoritative and comprehensive resources on Japanese honorific language, keigo structure, and practical deployment in both human and AI/automation contexts. For a deeper dive, visit the links above.
