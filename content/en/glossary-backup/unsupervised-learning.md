...
- When labeled data are scarce or costly to obtain.
...
If given a dataset of retail transactions with no customer labels, a clustering algorithm can segment customers into groups with similar buying behaviors, potentially revealing "frequent shoppers," "bargain hunters," etc.
## Types of Unsupervised Learning

### 1. Clustering

**Definition:**  
Clustering groups similar data points into clusters so that those within a cluster are more similar to each other than to points in other clusters.
...
**Definition:**  
Association rule learning discovers interesting relationships, frequent patterns, or correlations among variables in large datasets, usually expressed as "if-then" rules.
...
**Definition:**  
Dimensionality reduction simplifies datasets by reducing the number of variables while retaining as much relevant information as possible, improving model performance and data visualization.
...
**Unlabeled Data:**  
Data without explicit category labels or target values.

**Cluster:**  
A group of data points sharing similar characteristics, as determined by a clustering algorithm.

**Association Rule:**  
An "if-then" rule expressing the relationship or co-occurrence between items or variables.

**Principal Component:**  
A transformed variable (in PCA) capturing maximum variance in the data.

**Outlier:**  
A data point that significantly deviates from others in the dataset.

**Centroid:**  
The center point of a cluster, often the mean of its members (used in centroid-based clustering).

**Dendrogram:**  
A tree diagram used to illustrate the arrangement of clusters in hierarchical clustering.

**Feature Selection:**  
Choosing a subset of the most relevant features from the original dataset.

**Feature Extraction:**  
Transforming the input data into new features, often reducing dimensionality.

**Density:**  
In clustering, the concentration of data points in a region, used to define cluster boundaries.
