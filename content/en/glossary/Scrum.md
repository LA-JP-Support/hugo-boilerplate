...
|--------|-------|------------------------|
| **Planning Approach**| Adaptive planning with regular adjustments based on feedback and changing requirements | Comprehensive upfront planning with detailed project schedules and fixed scope |
| **Project Phases**| Iterative cycles with overlapping activities and continuous integration of feedback | Sequential phases with distinct gates and handoffs between different project stages |
| **Change Management**| Embraces change as natural and beneficial, with built-in mechanisms for adaptation | Treats change as scope creep requiring formal change control processes |
| **Risk Management**| Continuous risk identification and mitigation through frequent delivery and feedback | Risk assessment primarily during planning phase with periodic reviews |
| **Stakeholder Involvement**| High engagement throughout with regular reviews and continuous collaboration | Limited involvement after requirements gathering until final delivery and acceptance |
| **Documentation**| Working software over comprehensive documentation, with just enough documentation | Extensive documentation at each phase before proceeding to next stage |
