...
**State representation examples:**- **Chess:**Board position, piece locations, whose turn
...
**Example reward structures:**- **Goal-based:**+100 for reaching goal, 0 otherwise
...
**Breakthrough applications:**- AlphaGo: Defeated world champion Go player
