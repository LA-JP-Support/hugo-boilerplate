...
- **Salesforce Copilot** can draft emails, summarize sales records, or update CRM entries based on natural language prompts ([Salesforce: What is an AI Copilot?](https://www.salesforce.com/agentforce/ai-copilot/)).
...
**Example:**  
A support agent uses a copilot to generate a response to a shipping inquiry, pulling order status and policy from internal systems.

**Case Study:**  
[Moveworks Copilot](https://www.moveworks.com/us/en/resources/blog/what-does-an-ai-copilot-do) resolves IT and HR tickets instantly through context-aware chat.
...
**Example:**  
A salesperson leverages [Microsoft 365 Copilot](https://www.microsoft.com/en-us/microsoft-365/copilot/copilot-for-work) to draft follow-up emails and presentations, summarizing prior meetings and suggesting talking points.
...
**Case Study:**  
[Moveworks Copilot](https://www.moveworks.com/us/en/resources/blog/what-does-an-ai-copilot-do) automates 50% of access-related IT tickets instantly.
...
**Example:**  
A marketing analyst uses [ThoughtSpot Spotter](https://www.thoughtspot.com/product/ai-analyst) to generate reports and actionable insights from simple prompts.
...
**Example:**  
A manager uses Microsoft 365 Copilot to generate a performance summary from internal data sources.
...
They incorporate enterprise-grade security controls, encryption, and regulatory compliance (GDPR, HIPAA, etc.) ([Microsoft Responsible AI](https://www.microsoft.com/en-us/ai/responsible-ai)).
