...
| Term                    | Definition                                                                                                                         |
|-------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| **Text-to-Speech (TTS)**| Converts written text into spoken audio using computational models.                                                                 |
| **Speech Synthesis**    | Artificial generation of human speech.                                                                                             |
| **Node/Block**          | Modular workflow unit for a specific function (e.g. TTS conversion).                                                               |
| **Neural TTS**          | TTS powered by deep neural networks, enabling natural prosody and quality.                                                         |
| **SSML**                | XML-based markup controlling pronunciation, emphasis, pitch, etc. ([SSML Docs](https://www.w3.org/TR/speech-synthesis/))           |
| **Prosody**             | Rhythm, stress, and intonation patterns in speech.                                                                                 |
| **Vocoder**             | Algorithm converting acoustic representations to speech waveforms.                                                                  |
| **Caching (in TTS)**    | Storage of generated audio for repeated utterances.                                                                                |
| **Voice Model**         | Pre-trained AI model representing a specific voice.                                                                                |
| **Speech Service**      | Cloud/local API for speech synthesis (e.g., Azure, Google, OpenAI, ElevenLabs, [Advanced TTS MCP](https://github.com/samihalawa/advanced-tts-mcp)).|
| **Synthesized Speech**  | Output audio generated by a TTS system.                                                                                            |
| **Linguistic Analysis** | Stage determining pronunciation, stress, language features.                                                                        |
| **Custom Voice**        | Voice model trained for a specific speaker or brand. ([Azure Custom Neural Voice](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/custom-neural-voice))|
| **Real-time Synthesis** | On-demand speech generation with low latency.                                                                                      |
