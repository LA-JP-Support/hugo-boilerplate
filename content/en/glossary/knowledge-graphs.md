...
| **Relationships**| Connections to other entities |**Entity Examples by Type:**| Type | Examples | Common Properties |
|------|----------|------------------|
...
| **Spatial**| locatedIn, near, contains | Directed |**Relationship Properties:**| Property | Purpose | Examples |
|----------|---------|----------|
...
| **Confidence**| Certainty level | Probability score (0-1) |**Example Relationships:**```
...
**Node Properties:**| Property Type | Examples | Data Type |
|---------------|----------|-----------|
...
| **Descriptive**| Description, biography | Text |**Edge Properties:**| Property | Purpose | Example |
|----------|---------|---------|
...
**Ontology Components:**| Component | Description | Purpose |
|-----------|-------------|---------|
...
| **Hierarchies**| Class/property inheritance | Enable reasoning |**Ontology Example:**```
Class Hierarchy:
Thing
├── Person
│   ├── Employee
...
| **Unstructured**| Text documents, web pages | Entity extraction |**Stage 2: Entity Extraction**
...
| **Human Annotation**| Manual tagging | 95-99% |**Stage 3: Relationship Extraction**
...
| **ML Models**| Supervised learning | General-purpose |**Stage 4: Entity Resolution and Disambiguation**
...
| **Missing Data**| Incomplete information | Data enrichment |**Stage 5: Triple Creation**
...
**Enrichment Activities:**| Activity | Purpose | Method |
|----------|---------|--------|
...
| **Add Confidence Scores**| Quantify certainty | Probabilistic models |**Stage 7: Querying and Maintenance**

**Query Operations:**| Operation | Description | Example |
|-----------|-------------|---------|
...
**1. Ontology-Based Reasoning**| Rule Type | Description | Example |
|-----------|-------------|---------|
...
| **Subclass**| If A subClassOf B and B subClassOf C, then A subClassOf C | Class hierarchies |**2. Graph-Based Algorithms**| Algorithm | Purpose | Use Case |
|-----------|---------|----------|
...
| **Centrality**| Find key nodes | Influencer identification |**3. Statistical Inference**| Method | Description | Application |
|--------|-------------|-------------|
...
**Capabilities:**| Feature | Benefit | Example |
|---------|---------|---------|
...
**Application Types:**| Domain | Recommendation Type | Graph Features Used |
|--------|-------------------|-------------------|
...
**Detection Methods:**| Method | Description | Detection Rate |
|--------|-------------|---------------|
...
| **Behavioral Patterns**| Identify suspicious activity | 70-80% |**Use Cases:**| Industry | Application | Benefit |
|----------|-------------|---------|
...
**Applications:**| Application | Description | Impact |
|-------------|-------------|--------|
...
**Business Functions:**| Function | Use Case | Benefit |
|----------|----------|---------|
...
**Integration Points:**| NLP Task | Knowledge Graph Role | Enhancement |
|----------|-------------------|-------------|
...
**Q: How is a knowledge graph different from a graph database?**A: A graph database is storage technology for connected data. A knowledge graph is a data model with semantic meaning (ontologies, types, reasoning) often implemented using a graph database.**Q: Do I need a graph database to build a knowledge graph?**A: Not necessarily. Knowledge graphs can be implemented in relational databases, triple stores, or graph databases. Graph databases offer better performance for relationship queries.**Q: How long does it take to build a knowledge graph?**A: Initial implementation: 3-6 months for proof of concept, 12-18 months for production. Ongoing enrichment and expansion continue indefinitely.**Q: Can knowledge graphs work with unstructured data?**A: Yes. Entity extraction and relationship identification from unstructured text is a common knowledge graph construction method.**Q: What's the difference between a knowledge graph and an ontology?**A: An ontology is the schema/structure (classes, properties, rules). A knowledge graph is the actual data populating that structure with real-world instances.**Q: How do knowledge graphs support AI?**A: They provide structured background knowledge for reasoning, reduce hallucinations in LLMs (via RAG), and enable explainable AI decisions.
