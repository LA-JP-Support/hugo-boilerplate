...
| Method | Description | Response Time | Coverage |
|--------|-------------|---------------|----------|
...
| Level | User Impact | Business Effect | Examples |
|-------|-------------|-----------------|----------|
...
| Priority | First Escalation | Second Escalation | Executive Notification |
|----------|------------------|-------------------|----------------------|
...
| Approach | Description | Use Case | Time |
|----------|-------------|----------|------|
...
| Priority | Internal Updates | Customer Updates | Executive Updates |
|----------|-----------------|------------------|-------------------|
...
| Capability | Description | Success Rate |
|------------|-------------|--------------|
...
| Method | Data Source | Detection Type | Response Time |
|--------|-------------|----------------|---------------|
...
| System | Integration Purpose | Challenge |
|--------|-------------------|-----------|
...
A: Incidents should be logged immediately upon detection—within minutes for critical issues. Automated systems log instantly; manual reports should be logged within 15-30 minutes.

**Q: Who can report an incident?**

A: Anyone—end users, IT staff, automated monitoring systems, external partners. All incident sources are valid.
