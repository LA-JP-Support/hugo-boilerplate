...
- **Reference:** [Shelf.io: Fairness Metrics in AI](https://shelf.io/blog/fairness-metrics-in-ai/)  
- **Reference:** [Google ML Fairness Guide](https://developers.google.com/machine-learning/crash-course/fairness/evaluating-for-bias)
...
1. **Data Collection & Preparation**
   ...
   - Reference: [AI Bias and Data Collection](https://shelf.io/blog/ai-bias/)

2. **Model Training & Evaluation**
   - Train models on labeled datasets.
   - Evaluate model outputs across groups using fairness metrics.
   - Reference: [Google ML Crash Course - Fairness](https://developers.google.com/machine-learning/crash-course/fairness/evaluating-for-bias)
...
4. **Mitigation & Iteration**
   ...
   - Reference: [AIF360 Bias Mitigation Algorithms](https://aif360.readthedocs.io/en/latest/modules/generated/aif360.algorithms.html)
...
- **Reference:** [Fairness Metrics in AI—Your Step-by-Step Guide](https://shelf.io/blog/fairness-metrics-in-ai/#toc-header-3)
...
- **Reference:** [Shelf.io Fairness Metrics](https://shelf.io/blog/fairness-metrics-in-ai/#toc-header-3)
...
- **Reference:** [AIF360 Documentation](https://aif360.res.ibm.com/)
...
- **Reference:** [AIF360 Documentation](https://aif360.readthedocs.io/en/latest/modules/generated/aif360.metrics.html)
...
- **Reference:** [Forbes: AI & Fairness Metrics](https://councils.forbes.com/blog/ai-and-fairness-metrics)
...
- **Reference:** [Google ML Fairness Use Case](https://developers.google.com/machine-learning/crash-course/fairness/video-lecture)
...
- **Reference:** [NIST Face Recognition Vendor Test](https://www.nist.gov/programs-projects/face-recognition-vendor-test-frvt)
...
- **Reference:** [AIF360 Case Studies](https://aif360.res.ibm.com/)
...
- **Reference:** [Google AI Blog: Fairness in Healthcare](https://ai.googleblog.com/2019/10/ensuring-fairness-in-medical-ai.html)
...
1. **Use Multiple Metrics:**  
   ...
   - Reference: [Shelf.io Best Practices](https://shelf.io/blog/fairness-metrics-in-ai/#toc-header-5)
...
- **Documentation Standards:** Model cards and data sheets record fairness checks and risks.
  - Reference: [Model Cards](https://modelcards.withgoogle.com/about)
  - Reference: [Datasheets for Datasets](https://arxiv.org/abs/1803.09010)
