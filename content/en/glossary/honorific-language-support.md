...
description: "Honorific Language Support is an AI capability that recognizes and uses Japanese polite expressions correctly based on who you're talking to and the situation. It automatically chooses the right level of formality—respectful for superiors, humble for yourself, or polite for general conversation."
...
**Core Elements:**| Form | Structure | Example |
|------|-----------|---------|
...
**When talking to outsiders about your in-group:**- Use humble language for your side (even superiors)
...
**Email Automation:**| Scenario | Keigo Usage | Example Opening |
|----------|-------------|-----------------|
