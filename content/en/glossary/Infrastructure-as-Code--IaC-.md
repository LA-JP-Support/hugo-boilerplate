...
- [Configuration Drift](https://www.redhat.com/en/topics/automation/what-is-infrastructure-as-code-iac): When a system’s configuration diverges from the intended state.
- [Mutable vs. Immutable Infrastructure](https://www.geeksforgeeks.org/devops/what-is-infrastructure-as-code-iac/)
- [Declarative IaC](https://aws.amazon.com/what-is/iac/)

**Last updated:** June 2025

**For even more depth, explore:**  
- [Spacelift: Infrastructure as Code Deep Dive](https://spacelift.io/blog/infrastructure-as-code)  
- [AWS: What is Infrastructure as Code?](https://aws.amazon.com/what-is/iac/)  
- [Red Hat: Automation Topics](https://www.redhat.com/en/topics/automation)  

**Youtube Video Resources:**  
- [What is Infrastructure as Code? (AWS Official)](https://www.youtube.com/watch?v=zbKk0lU1bEU)  
- [Terraform In 10 Minutes (freeCodeCamp)](https://www.youtube.com/watch?v=SLB_c_ayRMo)  
- [Ansible Quick Start (TechWorld with Nana)](https://www.youtube.com/watch?v=wgQ3rHh9xqE)  
- [Kubernetes Explained (IBM Technology)](https://www.youtube.com/watch?v=PH-2FfFD2PU)

This glossary page is a comprehensive reference for understanding, adopting, and mastering Infrastructure as Code in any organization. All sections include direct links to authoritative, up-to-date resources for further exploration.
