...
**Example Scenario:**Query: "What's Air Canada's refund policy?" retrieves 5 documents, 3 are relevant → Precision@5 = 0.6. If 4 relevant documents exist and 3 are found → Recall@5 = 0.75.
