...
keywords: ["スロットキャリーオーバー", "AIチャットボット", "対話システム", "対話状態追跡", "コンテキスト管理"]
category: General
type: glossary
date: 2025-12-03
draft: false
...
このプロセスは[対話状態追跡](/ja/glossary/dialogue-state-tracking/)(DST)の基本であり、以下を含みます:
...
| [対話状態追跡](/ja/glossary/dialogue-state-tracking/)| ターンごとにスロット/値の完全なセットを追跡する   | シーケンスモデル、メモリネットワーク、フレーム追跡    |
