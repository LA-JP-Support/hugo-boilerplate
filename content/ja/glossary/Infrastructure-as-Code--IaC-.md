...
- [Configuration Drift](https://www.redhat.com/en/topics/automation/what-is-infrastructure-as-code-iac):システムの設定が意図した状態から逸脱すること。
...
この用語集ページは、あらゆる組織でInfrastructure as Codeを理解、採用、習得するための包括的なリファレンスです。すべてのセクションには、さらなる探求のための権威ある最新のリソースへの直接リンクが含まれています。