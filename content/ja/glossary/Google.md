...
**主要製品とサービス:**
- **[Gemini](Gemini.md)** - テキスト、画像、音声、動画の理解に優れた先進的なマルチモーダルAIモデルファミリー。Gemini 2.5 Proは最先端の推論、コーディング、拡張コンテキスト機能を提供
...
**関連製品記事:** Googleの主力マルチモーダルAIモデルファミリーの詳細については、[Gemini](Gemini.md)をご覧ください。
