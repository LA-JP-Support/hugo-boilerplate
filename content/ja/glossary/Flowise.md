...
date: 2025-12-03
draft: false
term: フローワイズようごしゅうおよびしょうさいぎじゅつガイド
reading: Flowise用語集および詳細技術ガイド
kana_head: その他
---
## **Flowiseとは?**
...
- **ベクトルデータベース統合:** Pinecone、ChromaDB、Weaviate、Milvusなどの組み込みサポート。
...
- **UneeQ Digital Humans:** 高度な会話型AIを備えたデジタルアバターの展開を効率化。
...
- **翻訳と多言語ボット:** 迅速な言語適応のためのプロンプトテンプレートを備えたLLMをデプロイ。
...
| エンタープライズ対応 | RBAC、SSO、暗号化シークレット、スケーラブル、オンプレミス/クラウド |
...
- **ベクトルDB:** Pinecone、ChromaDB、Weaviate、Milvusなど。
