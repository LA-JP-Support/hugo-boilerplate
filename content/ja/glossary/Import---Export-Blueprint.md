...
- **変数/パラメータ:** 入力、出力、[環境変数](/ja/glossary/environment-variables--secrets-/)、マッピングされたフィールド。
...
- **機密データ:** ブループリントファイルに認証情報や[シークレット](/ja/glossary/environment-variables--secrets-/)を保存しないでください。
