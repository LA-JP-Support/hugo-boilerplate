...
## [サポートポータル](/ja/glossary/Support-Portal/ "サポートポータルとは、FAQ、[チケット管理](/ja/glossary/ticket-management/ "チケット管理について学びましょう。専用ソフトウェアを使用して、顧客からの問い合わせや社内リクエストを体系的に記録、追跡、割り当て、解決するプロセスです。")、チャット機能などの顧客サポートリソースを一元化した安全なWebベースのシステムで、セルフサービスと効率的な問題解決を可能にします。")：お客様が自己解決できる｢魔法の本棚｣

### 問い合わせの30〜52%が消える！？

「[サポートポータル](/ja/glossary/Support-Portal/ "サポートポータルとは、FAQ、[チケット管理](/ja/glossary/ticket-management/ "チケット管理について学びましょう。専用ソフトウェアを使用して、顧客からの問い合わせや社内リクエストを体系的に記録、追跡、割り当て、解決するプロセスです。")、チャット機能などの顧客サポートリソースを一元化した安全なWebベースのシステムで、セルフサービスと効率的な問題解決を可能にします。")」とは、FAQやマニュアルをまとめた「お客様専用の図書館」のようなもの。
