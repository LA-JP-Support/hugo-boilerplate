...
3. **現在の対応状況**
   ...
   リアルタイムステータスページ(https://status.[liveagent](/ja/glossary/LiveAgent/).com/)の案内
...
メール、問い合わせフォーム、SNS（[Facebook](/ja/glossary/Facebook/)、[Instagram](/ja/glossary/Instagram/)、X(Twitter)など）、電話、チャットなど、あらゆる受付窓口からの問い合わせを一元管理し、同じ高精度で回答案を作成します。
