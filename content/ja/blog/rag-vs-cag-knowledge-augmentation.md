...
このガイドで説明されているRAGとCAGの技術は、すでに実世界のAIプラットフォームで適用されています。[FlowHunt](https://www.flowhunt.iは、Knowledge Sources機能を通じてRAGを実装しており、企業が企業文書、FAQ、ウェブサイトにAIチャットボットとワークフローを接続できるようにしています。これにより、一般的な訓練データではなく、検証済みの企業情報に基づいたAI応答が可能になります。[LiveAgent](https://www.liveagent.coは、AI Answer ImproverやAI ChatbotなどのAI機能を統合しており、ナレッジベースを参照して正確なカスタマーサポート応答を提供できます。
