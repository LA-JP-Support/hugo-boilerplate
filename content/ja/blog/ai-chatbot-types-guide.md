...
**技術的背景：**  
生成AIは大規模言語モデルを基盤としています。[OpenAI](/ja/glossary/OpenAI/)、[Google](/ja/glossary/Google/)、Anthropicなどが提供する最新モデルを使うことで、自然な文章を作る精度が大幅に向上しています。
...
### [教師あり学習](/ja/glossary/supervised-learning/)
...
### [教師なし学習](/ja/glossary/unsupervised-learning/)
...
### [強化学習](/ja/glossary/reinforcement-learning/)
...
最近では、テキストだけでなく、[音声認識](/ja/glossary/speech-recognition/)、[画像解析](/ja/glossary/image-analysis/)、動画の理解といったマルチモーダル技術も導入が進んでいます。
...
- **[生成AI](/ja/glossary/Generative-AI/)** - 未登録の質問にも柔軟な返答を作成（[OpenAI](/ja/glossary/OpenAI/)、[Google](/ja/glossary/Google/)、Anthropicの最新モデルを使用）
