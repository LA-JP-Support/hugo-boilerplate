...
## {{< tooltip text="問い合わせやサポート要求を番号付きの管理票として扱い、担当者や進捗状況を一元管理するシステム" >}}チケットシステム{{< /tooltip >}}という「魔法の杖」
...
## {{< tooltip text="顧客が自分で問題を解決できるよう、FAQ、マニュアル、ガイドなどの情報を集約したWebサイトやシステム" >}}サポートポータル{{< /tooltip >}}：お客様が自己解決できる｢魔法の本棚｣

### 問い合わせの30〜52%が消える！？

「サポートポータル」とは、{{< tooltip text="Frequently Asked Questions（よくある質問）の略で、顧客からよく寄せられる質問とその回答をまとめたコンテンツ" >}}FAQ{{< /tooltip >}}やマニュアルをまとめた「お客様専用の図書館」のようなもの。
...
| --- | --- | --- |
| 9:30 | 出社 | 出社 |
| 9:35 | メールチェック開始 | サポート専用{{< tooltip text="様々な情報やデータを一つの画面にまとめて表示する管理ツール" >}}ダッシュボード{{< /tooltip >}}を確認 |
| 9:40 |   | 未対応チケット3件、優先度「高」から処理 |
| 10:00 | Excelで管理表更新 | 自動振り分けされたチケットを各担当者が対応開始 各自平行してチャット対応も開始 |
...
### {{< tooltip text="投資した金額に対して、どれだけの効果や利益が得られるかを測る指標" >}}投資対効果{{< /tooltip >}}の簡単な計算
...
{{< tooltip text="企業の業務プロセスにデジタル技術を導入し、効率化や変革を図ること" >}}デジタル化{{< /tooltip >}}の波は、大企業だけのものではありません。むしろ、小規模企業こそテクノロジーを味方につけることで、大企業並みのサービスを提供できるチャンスがあります。
